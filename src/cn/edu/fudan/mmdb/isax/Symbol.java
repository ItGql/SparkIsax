...
import cn.edu.fudan.mmdb.sax.alphabet.Alphabet;
import cn.edu.fudan.mmdb.util.StackTrace;
...
//    consoleLogger.debug("pre-target: " + getBits(SAXNumber));
    logger.debug("pre-target: " + getBits(SAXNumber));
//    consoleLogger.debug("pre-local : " + getBits(this.saxCharacter));
    logger.debug("pre-local : " + getBits(this.saxCharacter));
...
//    consoleLogger.debug("bit diff: " + iNewBits);
    logger.debug("bit diff: " + iNewBits);
...
//    consoleLogger.debug("local : " + getBits(iLocalSAXNumber_Prefix));
    logger.debug("target: " + getBits(iTargetSAXNumber_Prefix));
    logger.debug("local : " + getBits(iLocalSAXNumber_Prefix));
...
//      consoleLogger.debug("PREFIX are GREATER THAN!");
      logger.debug("PREFIX are GREATER THAN!");
...
//    consoleLogger.debug("post-local : " + getBits(this.saxCharacter));
    logger.debug("post-target: " + getBits(SAXNumber));
    logger.debug("post-local : " + getBits(this.saxCharacter));
