...
import cn.edu.fudan.mmdb.sax.alphabet.NormalAlphabet;
import cn.edu.fudan.mmdb.timeseries.TPoint;
import cn.edu.fudan.mmdb.timeseries.TSUtils;
...
public class ISAXUtils {
  ...
  private static final Logger logger = LoggerFactory.getLogger(ISAXUtils.class);
  /**
...
//      System.out.println("Failed to build SAX for card: " + arCards);
      logger.error("Failed to build SAX for card: " + arCards);
    }
